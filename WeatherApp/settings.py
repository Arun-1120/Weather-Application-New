...
SECRET_KEY = 'django-insecure-+&9slu9d3d*&_0n-2lw!3&e&)p#-pyw)ars8&_zoen_(_*7#hg'
...
# Directory where static files are collected when running collectstatic (used in production)
